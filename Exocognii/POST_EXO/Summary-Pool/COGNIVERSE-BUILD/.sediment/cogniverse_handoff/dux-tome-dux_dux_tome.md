...
When An application is completed, it will reqiuire an Instructional Document.  (Dux Tome). 
You will either be asked for it,  or if the app is obviously finished.

---

## Naming Convention

The doc file takes the app's name suffixed with `-dux.tome.md`:
...
Examples:
```
Lexiferium-dux.tome.md
Dolium-dux.tome.md
Glyptorum-dux.tome.md
Fenestrium-dux.tome.md
```
...
```
# AppName
### One-paragraph description of what this application is
```
...
actually does right now. Make sure to calculate the empty spaces properly to line up all the 
box drawing borders.
