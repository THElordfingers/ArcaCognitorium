# ENTITEX REFINED · nuntius_emit.py · v1.0.0
"""
...
logger = logging.getLogger("entitex_refined.nuntius")

APP_ID = "ENTITEX_REFINED"
APP_VERSION = "2.0"
...
def _fallback_log(payload: dict, *, reason: str) -> None:
    print(
        f"[entitex_refined.nuntius] {reason}: hint={payload.get('hint')}",
        file=sys.stderr,
    )
