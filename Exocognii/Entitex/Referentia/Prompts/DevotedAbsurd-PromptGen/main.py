...
class MainWindow(QMainWindow):
    ...
    def _build_sidebar(self) -> QWidget:
        ...
        self.combo_mood.setMaximumWidth(290)
    ...
    def _build_main(self) -> QWidget:
        ...
        self.prompt_output.setPlaceholderText("// Prompt will appear here after generation.\n// You can also edit it manually before analysing.")
        ...
        self.lbl_user_score_val.setStyleSheet(f"color: {C['amber']}; font-size: 16px; font-weight: bold;")
        ...
        self.txt_reasoning.setStyleSheet(f"background: {C['panel2']}; border: 1px solid {C['border']}; color: {C['text_dim']}; font-size: 11px;")
        ...
        self.txt_refined.setStyleSheet(f"background: {C['bg']}; border: 1px solid {C['border']}; color: {C['text']}; font-size: 12px; padding: 10px;")
        ...
        self.input_iterate.setPlaceholderText("Tell Claude what to push / change / explore next...")
        ...
        self.history_list.setStyleSheet(f"font-size: 11px;")
        ...
        self.txt_stats.setStyleSheet(f"background: {C['panel2']}; border: 1px solid {C['border']}; color: {C['text_dim']}; font-size: 11px;")
    ...
    def _on_claude_done(self, entry_id: str, result: dict):
        ...
        self.lbl_claude_score.setStyleSheet(f"color: {color}; font-size: 22px; font-weight: bold;")
    ...
    def _reset_claude_panel(self):
        ...
        self.lbl_claude_score.setStyleSheet(f"color: {C['muted']}; font-size: 22px; font-weight: bold;")
    ...
    def _on_slider_change(self, val: int):
        if val == 0:
            ...
            self.lbl_user_score_val.setText(str(val))
    ...
    def _update_stats_footer(self):
        ...
        self.lbl_stats.setText(
            f"{n} generated  |  avg score: {avg or '—'}"
        )
...
def main():
    ...
    # Load monospace font if available
